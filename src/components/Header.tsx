      ...
      <div className="actions">
        <div className="start">
          <button
            ...
            data-tooltip={t('header.filterTooltip')}
          >
        ...
        <div className="end">
          <button className={`btn btn_icon btn_warning dimmer${dimClass}`} onClick={onBlock} data-tooltip={t('header.blockTooltip')}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button className="btn btn_icon btn_danger" onClick={onLeave} data-tooltip={t('header.leaveTooltip')}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="field_group i_am">
          ...
          <div className="radio-group">
            ...
            <label className="radio-option">
              ...
              <div className="btn btn_default">{t('header.any')}</div>
            </label>
          </div>
        </div>

        <div className="field_group">
          <span>{t('header.lookingFor')}</span>
          <div className="radio-group">
            <label className="radio-option">
